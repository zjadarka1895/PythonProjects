...
def solve_jacobi(A, b):
    ...
    return r_norm, iteration_count, round(time_c, 1)
...
def solve_gauss_seidel(A, b, tol=1e-10, max_iter=1000):
    ...
    time_c = (time.time() - start) # czas w milisekundach
    return r_norm, iteration_count, round(time_c, 1)
...
if __name__ == '__main__':
    ...
    plt.semilogy(r_norm)
    plt.legend([f"Jacobi l. iteracji: {ic_j}, czas: {time_j} s", f"Gauss-Seidel l. iteracji: {ic_gs}, czas: {time_gs} s"])
